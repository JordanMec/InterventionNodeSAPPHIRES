...
fprintf('[runManualComparison] Starting comparison...\n');
...
try
    ...
    fprintf('[runManualComparison] Loading data from: %s\n', matFile);
    S = load(matFile,'OUT');
    if ~isfield(S,'OUT')
    ...
    fprintf('[runManualComparison] Running simulation: HEPA OFF\n');
    ...
    fprintf('[runManualComparison] Running simulation: HEPA ON\n');
    ...
    fprintf('[runManualComparison] Creating visualizations...\n');
    ...
    fprintf('[runManualComparison] Script complete.\n');
catch ME
    fprintf('[ERROR] in runManualComparison: %s\n', ME.message);
    fprintf('Line: %d\n', ME.stack(1).line);
    rethrow(ME);
end
end